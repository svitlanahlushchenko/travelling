        ...
        <div className="footer__container">
          ...
          <div className="footer__gallery">
            ...
            <div className="footer__photo-container">
              <img className="footer__photo" src='/images/gallery1.png' alt="Beauty" />
              <img className="footer__photo" src='/images/gallery2.png' alt="Beauty" />
              <img className="footer__photo" src='/images/gallery3.png' alt="Beauty" />
              <img className="footer__photo" src='/images/gallery4.png' alt="Beauty" />
              <img className="footer__photo" src='/images/gallery5.png' alt="Beauty" />
              <img className="footer__photo" src='/images/gallery6.png' alt="Beauty" />
            </div>
          </div>
        </div>
